...
async def _run_service(args: argparse.Namespace) -> int:
    # TODO: Connect the client, read the service info resource,
    # print it as JSON, and return a success exit code.
    raise NotImplementedError("Workshop exercise: implement _run_service().")


async def _run_tools(args: argparse.Namespace) -> int:
    # TODO: Connect the client, list the server tools,
    # print each tool name and description, and return a success exit code.
    raise NotImplementedError("Workshop exercise: implement _run_tools().")
